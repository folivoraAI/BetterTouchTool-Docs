---
title: "Keyboard Shortcut Triggers"
sidebar_position: 1
slug: "/docs/keyboard-shortcuts/overview"
---
# Keyboard Shortcuts
...
A shortcut in BTT always requires at least one normal, non modifier, key. However BTT also supports any other key combination via [Key Sequences](/docs/keyboard-shortcuts/key-sequences). For example if you want to trigger something while pressing only one or more modifier keys (cmd, ctrl, shift, fn, option) you can set up a Key Sequence for this.
See [Key Sequences](/docs/keyboard-shortcuts/key-sequences)
