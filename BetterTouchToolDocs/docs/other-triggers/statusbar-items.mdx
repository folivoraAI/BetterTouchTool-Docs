---
title: "Custom Menubar Status Items"
sidebar_position: 6
slug: "/docs/other-triggers/statusbar-items"
---
# Custom Menubar Status Items / Icons
![custom-items1](/media/menubar_custom_status_item.png)
...
* AppleScript / JavaScript Menu Bar Icon (Scriptable)
* Shell Script Menu Bar Icon (Scriptable)

![custom menubar items](/media/custom_menubar_item_setup.png)
...
![right-click](/media/menubar_item_right_click_actions.png)
