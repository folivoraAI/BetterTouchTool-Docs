---
title: "Reusable Named Triggers"
sidebar_position: 4
slug: "/docs/other-triggers/named-triggers"
---
...
Named Triggers can be called using the [BetterTouchTool scripting interfaces](/docs/scripting/overview) using the **trigger_named** function. This allows you to configure any sequence of actions within BTT and trigger it using e.g. AppleScript or from within a floating webview.
