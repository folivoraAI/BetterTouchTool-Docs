---
title: "BTT as Default Browser / URL Based Triggers"
sidebar_position: 5
slug: "/docs/other-triggers/url-triggers"
---
...
It's also possible to show a menu with a list of possible browsers when clicking on a link. To do this use the predefined action "Show Custom Context Menu" and create multiple [Named Triggers](/docs/other-triggers/named-triggers), one for every browser you want to support:
