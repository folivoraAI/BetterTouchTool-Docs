...
sidebar_position: 5
slug: "/docs/floating-menus/scripting"
---
# Scripting Floating Menus

## Dynamically retrieve content of Floating Menu

Starting with BetterTouchTool 4.764 you can use the new [Simple JSON Format](/docs/scripting/simple-format) in combination with JavaScript to dynamically retrieve the contents of a floating menu.

Have a look at [Simple JSON Format](/docs/scripting/simple-format) for details on how to use it.

For complete menu imports, AI-generated floating menus, and the full menu/item JSON structure, see [Creating Floating Menus With JSON and AI](/docs/floating-menus/json-ai-creation).
...
<img style={{maxHeight: '500px'}} src="/media/script_example.png"/><br />
