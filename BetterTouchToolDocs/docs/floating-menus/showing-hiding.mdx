...
sidebar_position: 3
slug: "/docs/floating-menus/showing-hiding"
---
...
To make a menu show up in a group of apps or for specific windows or on specific websites, you can create a [conditional activation group](/docs/actions/conditions) and assign it to that
