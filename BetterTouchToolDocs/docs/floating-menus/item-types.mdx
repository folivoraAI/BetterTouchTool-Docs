...
title: "Item Types"
sidebar_position: 4
slug: "/docs/floating-menus/item-types"
---
# Floating Menu Items
...
For documentation on this, see [Floating HTML / Web Views](/docs/webview/overview)
...
### Textfield Items
Allow entering some text. The text can be accessed via the Floating Menu scripting interfaces. See [Scripting Floating Menus](/docs/floating-menus/scripting)
