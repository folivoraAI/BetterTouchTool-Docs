...
You can also create your own [native Swift plugin widgets](/docs/floating-menus/swift-plugins) to embed custom views into floating menus.

If you want to create menus programmatically, import generated JSON, or use the BetterTouchTool AI assistant, see [Creating Floating Menus With JSON and AI](/docs/floating-menus/json-ai-creation).
