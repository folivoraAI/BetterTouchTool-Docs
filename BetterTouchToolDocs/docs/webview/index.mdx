---
title: "Custom Scriptable WebView"
sidebar_position: 1
slug: "/docs/webview/overview"
---
# Custom WebView / HTML Renderer

**Note, October 14, 2023: With BetterTouchTool versions >= 4.25, the new [Floating Menus](/docs/floating-menus/overview) can contain the webview described here by using web view items. This is very powerful and should be preferred instead of using the 'Show Floating WebView action'.**
...
* [Basic Setup & Providing Content](/docs/webview/basic-setup)
* [Appearance & Configuration options](/docs/webview/config)
* [Triggering BTT functionality from the webview](/docs/webview/javascript)
* [Triggering & displaying the results of Terminal or AppleScripts in the webview](/docs/webview/scripts)
* [WebView Lifecycle & Notifications](/docs/webview/lifecycle)
* [Starter Template](/docs/webview/starter-template)
* [Development Tips & Tricks](/docs/webview/development)
