...
- [Scroll Modifiers](#scroll-modifiers)
  - [Setup a Scroll Modifier:](#setup-a-scroll-modifier)
  - [App Specific Scroll Modifiers](#app-specific-scroll-modifiers)
  - [Detailed Scroll Modifier Description:](#detailed-scroll-modifier-description)
    - [Smooth Scrolling (like Trackpad)](#smooth-scrolling-like-trackpad)
    - [Vertical \& Horizontal Scroll Speed Modifier](#vertical--horizontal-scroll-speed-modifier)
    - [Block Horizontal Scrolling](#block-horizontal-scrolling)
    - [Block Vertical Scrolling](#block-vertical-scrolling)
    - [Scroll Acceleration Curve](#scroll-acceleration-curve)
    - [Reverse Scroll Direction](#reverse-scroll-direction)
    - [Swap Scroll Axes (H ↔ V)](#swap-scroll-axes-h-%E2%86%94-v)
    - [Lock Scroll to Dominant Axis](#lock-scroll-to-dominant-axis)
    - [Scroll Dead Zone Filter](#scroll-dead-zone-filter)
    - [Scroll Event Debounce](#scroll-event-debounce)
    - [Clamp Maximum Scroll Speed](#clamp-maximum-scroll-speed)
    - [Scroll Distance Per Tick](#scroll-distance-per-tick)
    - [Smooth Zoom (Scroll to Magnify)](#smooth-zoom-scroll-to-magnify)
    - [Smooth Rotate (Scroll to Rotation)](#smooth-rotate-scroll-to-rotation)
    - [Smooth Space Switch (Scroll to Switch Spaces)](#smooth-space-switch-scroll-to-switch-spaces)
...
If you want to have the scroll modifiers enabled for most apps but exclude some, please use a [Conditional Activation Group ](2_2_preferences_global_vs_app_specific.md)
