...
* [Via OSC / Open Sound Control](/docs/scripting/osc)
* [From Node.js / TypeScript via the official npm package](/docs/scripting/node-js-library) (works with the socket server, the webserver and inside BTT)
