...
- [Logitech Mouse Support](#logitech-mouse-support)
  - [Setup](#setup)
  - [Example Preset: MX Master](#example-preset-mx-master)
  - [Example Preset: MX Vertical](#example-preset-mx-vertical)
  - [Example Preset: MX Anywhere 3 / MX Anywhere 3S](#example-preset-mx-anywhere-3--mx-anywhere-3s)
  - [Remapping Buttons](#remapping-buttons)
  - [Smooth Scrolling](#smooth-scrolling)
  - [Configure Tilt Wheel Buttons To Scroll](#configure-tilt-wheel-buttons-to-scroll)
  - [Trackpad Like Gestures (Zooming, Rotating, Space Switching)](#trackpad-like-gestures-zooming-rotating-space-switching)
  - [Action Ring \& Other Fancy Menus](#action-ring--other-fancy-menus)
    - [Bugs, Feature Requests \& Discussion:](#bugs-feature-requests--discussion)
...
After you have added the Logitech Mouse Configuration, your mouse buttons should be recognized and you can configure them like described in [Assigning Actions To Normal Mice](802_normal_mice_assigning_actions.md)
...
BetterTouchTool supports smooth scrolling for any mouse, not just Logitech mice. To enable it add a [Smooth Scroll Modifier](4001_scroll_modifiers.md)
...
Trackpad like gestures can also be configured via scroll modifiers: [Scroll Modifier](4001_scroll_modifiers.md)
