---
title: "Manage Menubar Status Items"
sidebar_position: 1
slug: "/docs/menubar/status-items"
---
...
* A "Menubar Status Item" Widget that can be placed in a [Floating Menu](/docs/floating-menus/overview)
...
The preset shared above assigns this action to a [custom menubar status item](/docs/other-triggers/statusbar-items) and configures the action to hide any item left of that item itself.
