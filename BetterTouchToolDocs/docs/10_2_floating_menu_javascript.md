...
**Important Note**: When loaded the webview takes a few milliseconds to initialize BTT's scripting infrastructure. This is why you should only call the scripting functions after the BTTInitialized function has been called (or you can use some fixed delay). For more information see [webview lifecycle](10_4_webview_lifecycle.md)
