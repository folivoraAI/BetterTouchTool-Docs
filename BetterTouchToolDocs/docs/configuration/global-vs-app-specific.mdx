---
title: "Global and App Specific Triggers"
sidebar_position: 4
slug: "/docs/configuration/global-vs-app-specific"
---
...
3. **Use Conditional Activation Groups**:
   - Define conditions to specify where the trigger should be active. See the [previous section](#specify-triggers-for-groups-of-apps) for details.
...
This functionality allows you to dynamically adjust menus based on the active app or the active [Conditional Activation Group](/docs/actions/conditions).
