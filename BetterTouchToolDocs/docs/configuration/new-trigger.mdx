---
title: "Setting up a new Trigger"
sidebar_position: 3
slug: "/docs/configuration/new-trigger"
---
...
So just press the plus button in the Action List, select the action type (e.g. a keyboard shortcut to send or one of the predefined actions to execute):
...
In case you encounter any issues it's often helpful to assign a "failsafe" action like Mission Control to see whether the trigger works.
