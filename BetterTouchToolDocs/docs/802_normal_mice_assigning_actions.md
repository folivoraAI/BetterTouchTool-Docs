...
- [Assigning actions to your mouse](#assigning-actions-to-your-mouse)
  - [Assign Actions To Mouse Buttons](#assign-actions-to-mouse-buttons)
    - [Simple Mouse Button =\> Action Assignment](#simple-mouse-button--action-assignment)
    - [Mouse Button + Modifier Key =\> Action Assignment](#mouse-button--modifier-key--action-assignment)
    - [Mouse Button + Drag Up/Down/Left/Right Gestures](#mouse-button--drag-updownleftright-gestures)
      - [Discrete And Continuous Drag Gestures](#discrete-and-continuous-drag-gestures)
      - [Using Drag Gestures to Simulate macOS Trackpad Gestures](#using-drag-gestures-to-simulate-macos-trackpad-gestures)
    - [Click + Release Actions](#click--release-actions)
    - [Short + Long Press](#short--long-press)
    - [Multi Button Combinations](#multi-button-combinations)
    - [Action Ring \& Other Fancy Menus](#action-ring--other-fancy-menus)
...
While BetterTouchTool also offers a sophisticated mouse gesture system (see [Drawings / Mouse Gestures](701_drawings.md)) it now also supports easy to set up drag up/down/left/right gestures for any pressed mouse button. To use these simple drag gestures, add your mouse button like described above, then click the "Add Action For Trigger Category" button, then choose one of the drag gestures:
