---
title: "Logitech JavaScript"
sidebar_position: 4
slug: "/docs/normal-mouse/logitech-javascript"
---
# Logitech JavaScript API Documentation

BetterTouchTool >= 5.798 provides a JavaScript API for controlling Logitech HID++ devices (mice, keyboards). All functions support async/await and return Promises. You can use these within the predefined action "Run Real JavaScript". Also have a look at [BTT Real JavaScript](/docs/scripting/java-script)
## Table of Contents
