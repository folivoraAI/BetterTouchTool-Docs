---
title: "Magic Mouse & Trackpad Triggers"
sidebar_position: 1
slug: "/docs/trackpad-mouse/magic-mouse-trackpad"
---
...
* **Advanced Trigger Conditions**
  * You can define advanced trigger conditions that allow you to define lots of conditions on when a gesture is allowed to trigger. See [](/docs/actions/conditions) for more details.
