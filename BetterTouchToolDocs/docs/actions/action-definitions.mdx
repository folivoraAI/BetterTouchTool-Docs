...
* **BTTHUDActionConfiguration**: HUD configuration JSON string (legacy format)
* **BTTAdditionalActionData**: JSON object with HUD configuration
  ...
  - `BTTActionHUDBackground`: string - Background color (hex, e.g. "#000000CC")
  ...
  - `BTTActionHUDBorderColor`: string - Border color (hex)
...
* **BTTAdditionalActionData**: JSON object (optional) with positioning configuration
  ...
  - `BTTActionLauncherOpenGroup`: string (optional) - title of a top-level launcher group to open immediately when the launcher appears (for example `Apps`). Matched case- and diacritic-insensitively against the group title or identifier.
