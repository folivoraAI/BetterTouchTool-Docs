...
* **BTTActionData** (start / toggle only, JSON, all optional):
  ...
  * `BTTKeyboardCleanModeOverlayOpacity`: number 10-100, darkening strength in percent, default `100`
