---
title: "Insert / Type / Paste Custom Text"
sidebar_position: 5
slug: "/docs/actions/paste-custom-text"
---
...
You can access any variables that have been defined in BTT [(they can be defined via scripts)](/docs/scripting/variables)
...
Starting with BTT 3.356 this action allows to transform the text using [custom JavaScript transformer functions](/docs/actions/text-transformer) before pasting it.
