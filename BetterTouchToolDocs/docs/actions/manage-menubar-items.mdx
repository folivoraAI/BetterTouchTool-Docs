---
title: "Manage Menu Bar Status Items"
sidebar_position: 11
slug: "/docs/actions/manage-menubar-items"
---
...
In this example BetterTouchTool is set up to toggle hide/show items left of the wifi icon via custom menu bar icons.
...
![alt text](/media/manage_menubar_status_items.png)
