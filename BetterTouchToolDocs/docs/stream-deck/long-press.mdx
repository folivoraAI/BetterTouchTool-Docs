...
title: "Long Press"
sidebar_position: 3
slug: "/docs/stream-deck/long-press"
---
...
2. **Configure Long Press Action**: Check the "Trigger named trigger on long press" checkbox, then select (or create) a [Named Trigger](/docs/other-triggers/named-triggers) that will be executed if the button is long-pressed.
