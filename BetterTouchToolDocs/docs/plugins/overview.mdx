...
For launcher-specific behavior from a user's point of view, see [Launcher Plugins](/docs/launcher/plugins). For authoring launcher plugins, see [Launcher Plugins](/docs/plugins/launcher).
