---
title: "Basic Window Snapping Setup"
sidebar_position: 2
slug: "/docs/window-snapping/basic-setup"
---
...
<video width="100%" controls style={{marginBottom: '20px', maxWidth: '1200px'}}>
...
On how to access the settings see [Settings](/docs/configuration/settings).
