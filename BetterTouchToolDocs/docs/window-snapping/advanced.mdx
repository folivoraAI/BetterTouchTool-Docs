...
sidebar_position: 3
slug: "/docs/window-snapping/advanced"
---
...
To access and change the window snapping settings, open the preferences window and adjust as you want. On how to access the settings see [Settings](/docs/configuration/settings).
...
### Custom Snap Areas
If you need more customization options and maybe even want to snap your windows to other positions & sizes than offered by default, have a look at the [Custom Snap Area Section](/docs/window-snapping/snap-areas).
