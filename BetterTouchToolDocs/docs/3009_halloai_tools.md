...
## Table of Contents
- [h@llo.ai Available Tools](#hlloai-available-tools)
  - [Table of Contents](#table-of-contents)
  - [UI Automation: End‑to‑End Flow](#ui-automation-end%E2%80%91to%E2%80%91end-flow)
    - [1) Discover running apps](#1-discover-running-apps)
    - [2) Inspect UI hierarchy](#2-inspect-ui-hierarchy)
    - [3) Search elements](#3-search-elements)
    - [4A) Click an element](#4a-click-an-element)
    - [4B) Type into an element](#4b-type-into-an-element)
    - [4C) Diagnose when things fail](#4c-diagnose-when-things-fail)
  - [Mouse, Keyboard \& Text](#mouse-keyboard--text)
    - [Pointer \& clicks](#pointer--clicks)
    - [Keyboard \& text](#keyboard--text)
    - [Heads-up display](#heads-up-display)
    - [Haptics \& clipboard](#haptics--clipboard)
    - [Wait helper](#wait-helper)
  - [Computer Control (Full Desktop Agents)](#computer-control-full-desktop-agents)
  - [Browser \& Web](#browser--web)
  - [Screen, Windows \& OCR](#screen-windows--ocr)
  - [Files \& Projects](#files--projects)
    - [Create, read, write](#create-read-write)
    - [Edit \& patch](#edit--patch)
    - [Find files \& content](#find-files--content)
  - [Versioning \& History](#versioning--history)
  - [Diagnostics for Code](#diagnostics-for-code)
  - [Variables, Clipboard, Haptics, Wait](#variables-clipboard-haptics-wait)
  - [Calendars \& Reminders](#calendars--reminders)
  - [Menubar \& Triggers](#menubar--triggers)
  - [Scripting](#scripting)
  - [BetterTouchTool Knowledge Search](#bettertouchtool-knowledge-search)
  - [Global JavaScript Utilities](#global-javascript-utilities)
