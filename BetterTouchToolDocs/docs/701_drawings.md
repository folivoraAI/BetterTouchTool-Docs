...
- [Custom Drawing Gestures / Mouse Gestures](#custom-drawing-gestures--mouse-gestures)
  - [Adding New Gestures](#adding-new-gestures)
  - [Using the Gestures](#using-the-gestures)
  - [Using Specific Mouse Buttons For Drawing Gestures](#using-specific-mouse-buttons-for-drawing-gestures)
  - [Scopes](#scopes)
  - [Andreas, Which gestures are you using to start drawing recognition?](#andreas-which-gestures-are-you-using-to-start-drawing-recognition)
  - [Tipps \& Tricks](#tipps--tricks)
  - [Some Drawing settings are available in the Advanced Settings:](#some-drawing-settings-are-available-in-the-advanced-settings)
