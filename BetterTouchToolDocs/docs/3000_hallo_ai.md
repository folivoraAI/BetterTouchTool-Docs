...
Go to [Getting Started](3002_halloai_getting_started.md) if you want to see instructions on how to get started with your own assistant.

## The Chat Interface
While h@llo.ai assistants can also operate without showing user interface (see [Use Without Showing UI](3010_halloai_usage_without_ui.md)), most of the time you'll probably want to use the chat interface:
...
For a list of all available tools and instructions how to configure them have a look here: [Available Tools and How To Configure Them](3009_halloai_tools.md)

### MCP

In case the built in tools do not cover your requirements, you can also link MCP servers. See [](3012_halloai_mcp.md)

### Custom User Defined Tools

BetterTouchTool also allows to create custom tools the AI can access. Custom tools are based on [Named Triggers](1002_named_triggers.md)
...
See [h@llo - Context](3008_halloai_context.md) for more details on how to configure your Assistant's context.
...
Sometimes it might be good to have a generic main chat and delegate specific tasks to specific AI models with different instructions. For this BetterTouchTool allows you to define custom specialized sub-agents. They can use different API's than the main chat and you can provide custom tools, context and instructions to them.
The main chat can then call these subagents when needed.

See [Subagents](3013_halloai_subagents.md) for info on how to set them up.

## Projects

When calling the AI Assistant while in some sort of project, 
BTT checks whether there is an AGENT.md or BTT.md file. If so it will read the content of that file and use it to adapt the assistant to the project.