...
**Important:** Even after configuring your MCP JSON file, you still need to activate the MCP tools individually for any of your assistants. This is done in the [Tools & Context section in the configuration](/docs/ai-assistants/tools).
