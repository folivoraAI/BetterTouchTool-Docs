...
See [Memory](/docs/ai-assistants/memory) for details on how the memory system works.
...
See [Extended Thinking](/docs/ai-assistants/extended-thinking) for configuration details.
