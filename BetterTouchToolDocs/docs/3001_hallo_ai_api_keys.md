...
1. Create an Anthropic Console acccount via https://console.anthropic.com/
...
The Open AI comptaible API URL for Gemini is https://generativelanguage.googleapis.com/v1beta/openai/v1/chat/completions
